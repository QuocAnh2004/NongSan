...
public class ChangePassController {
    ...
    public String showChangePasswordForm(Model model, HttpSession session) {
        String loggedInUsername = (String) session.getAttribute("loggedInUser"); // Giả sử bạn lưu tên người dùng đăng nhập trong session
...
//        if (!existingUser.getPassword().equals(user.getOldPassword())) 
        ...
        return "redirect:/app/user/index"; // Redirect về trang chủ hoặc bất kỳ trang nào khác
    }
}
