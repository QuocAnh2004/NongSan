                                ...
                                <div class="row g-4">
                                            ...
                                            <div class="col-lg-12">
                                                ...
                                                <div class="d-flex align-items-center justify-content-start">
                                                    <div class="rounded me-4" style="width: 100px; height: 100px;">
                                                        <img src="<c:url value='template/user/img/featur-1.jpg' />"
                                    ...
                                    <div class="col-lg-9">
                                        <div class="row g-4 justify-content-center">
                                            <c:forEach var="product" items="${items_products.content}"> <!--.CONTENT ĐỂ truy cập các phần tử trong trang hiện tại-->
                                                <div class="col-md-6 col-lg-6 col-xl-4">
                                                    ...
                                                    <div class="rounded position-relative fruite-item">
                                                        <div class="fruite-img">
                                                            <!-- Sử dụng c:url để tạo URL động cho hình ảnh -->
                                                            <c:url value="/template/user/picture/${product.imageUrl}" var="imageUrl"/>
                                                            <img src="${imageUrl}" class="img-fluid w-100 rounded-top" alt="${product.productName}">
                                                        </div>
                                                        ...
                                                        <div class="p-4 border border-secondary border-top-0 rounded-bottom">
                                                            ...
                                                            <div class="d-flex justify-content-between flex-lg-wrap">
                                                                ...
                                                                <a href="#Â" class="btn border border-secondary rounded-pill px-3 text-primary">
                                            ...
                                            <div class="col-12">
                                                <div class="pagination d-flex justify-content-center mt-5">
                                                    <c:if test="${items_products.hasPrevious()}">
                                                        <!-- Nút đi đến đầu -->
                                                        <!-- Luôn chuyển hướng đến trang đầu tiên (page=0) -->
                                                        <a href="?page=0" class="rounded">FIRST</a>
                                                        
                                                        <!-- Nút đi đến trang trước -->
                                                        <!-- Chuyển hướng đến trang trước đó (page hiện tại - 1) -->
                                                        <a href="?page=${items_products.number - 1}" class="rounded">&laquo;</a>
                                                    </c:if>
                                                    
                                                    <!-- Nút cho các trang cụ thể -->
                                                    <!-- Duyệt qua tất cả các trang và tạo liên kết đến từng trang -->
                                                    <c:forEach begin="0" end="${items_products.totalPages - 1}" var="i">
                                                        <!-- Thêm lớp 'active' nếu là trang hiện tại -->
                                                        <a href="?page=${i}" class="rounded ${items_products.number == i ? 'active' : ''}">${i + 1}</a>
                                                    </c:forEach>
                                                    
                                                    <c:if test="${items_products.hasNext()}">
                                                        <!-- Nút đi đến trang tiếp theo -->
                                                        <!-- Chuyển hướng đến trang tiếp theo (page hiện tại + 1) -->
                                                        <a href="?page=${items_products.number + 1}" class="rounded">&raquo;</a>
                                                        
                                                        <!-- Nút đi đến cuối -->
                                                        <!-- Luôn chuyển hướng đến trang cuối cùng (page = totalPages - 1) -->
